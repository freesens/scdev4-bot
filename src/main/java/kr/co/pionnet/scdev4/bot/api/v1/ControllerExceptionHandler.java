...
public class ControllerExceptionHandler {
    ...
    public ResponseV1<?> handleException(IllegalStateException e) {
        log.error(e.getMessage(), e);

        return ResponseV1.builder(ApiResultEnum.SUCCESS.getCode(), NoticeMessage.clientMessage.ALREADY_CLICKED).build();
    }
